...
const headers = [
  ...
  { title: 'Título', key: 'title', minWidth: '220px' },
  ...
  { title: 'Ações Pendentes', key: 'pendingTasks', minWidth: '180px', sortable: false },
  { title: 'Iniciado em', key: 'createdAt', width: '160px' },
  { title: 'Última Atividade', key: 'lastActivityAt', width: '170px' },
